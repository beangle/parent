...
object Dependencies extends sbt.AutoPlugin {
  ...
  val tomcat_embed_core = "org.apache.tomcat.embed" % "tomcat-embed-core" % "10.1.19"
  val io_undertow_core = "io.undertow" % "undertow-core" % "2.3.12.Final"
  val io_undertow_servlet = "io.undertow" % "undertow-servlet" % "2.3.12.Final"
