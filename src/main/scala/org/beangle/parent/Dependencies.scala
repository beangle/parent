...
object Dependencies extends sbt.AutoPlugin {
  ...
  //cdi
  val spring_beans = "org.springframework" % "spring-beans" % "5.3.10"
  val spring_context = "org.springframework" % "spring-context" % "5.3.10"
  val spring_tx = "org.springframework" % "spring-tx" % "5.3.10"
  val spring_aop = "org.springframework" % "spring-aop" % "5.3.10"
  val spring_jdbc = "org.springframework" % "spring-jdbc" % "5.3.10"
  val protobuf = "com.google.protobuf" % "protobuf-java" % "3.18.0"
  ...
  val mysql_connector_java = "mysql" % "mysql-connector-java" % "8.0.26"
  val mssql_jdbc = "com.microsoft.sqlserver" % "mssql-jdbc" % "9.4.0.jre11"

  val tomcat_embed_core = "org.apache.tomcat.embed" % "tomcat-embed-core" % "10.0.11"
