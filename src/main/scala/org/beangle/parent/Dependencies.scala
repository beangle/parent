...
object Dependencies extends sbt.AutoPlugin {
  ...
  val protobuf = "com.google.protobuf" % "protobuf-java" % "3.21.8"
  ...
  val bcprov_jdk15to18 = "org.bouncycastle" % "bcprov-jdk15to18" % "1.72"
  val bcpkix_jdk15to18 = "org.bouncycastle" % "bcpkix-jdk15to18" % "1.72"

  //cache
  val ehcache = "org.ehcache" % "ehcache" % "3.10.2"
  ...
  val mysql_connector_java = "mysql" % "mysql-connector-java" % "8.0.31"
  val mssql_jdbc = "com.microsoft.sqlserver" % "mssql-jdbc" % "10.2.1.jre11"

  val tomcat_embed_core = "org.apache.tomcat.embed" % "tomcat-embed-core" % "10.1.1"
  val io_undertow_core = "io.undertow" % "undertow-core" % "2.3.0.Final"
  val io_undertow_servlet = "io.undertow" % "undertow-servlet" % "2.3.0.Final"
