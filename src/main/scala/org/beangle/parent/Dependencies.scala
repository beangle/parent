...
object Dependencies extends sbt.AutoPlugin {
  ...
  val jcl_over_slf4j = "org.slf4j" % "jcl-over-slf4j" % "2.0.13"
  ...
  val itext = "com.itextpdf" % "itext-core" % "8.0.3"
  ...
  val jgroups = "org.jgroups" % "jgroups" % "5.3.6.Final"
  val jedis = "redis.clients" % "jedis" % "5.1.2"
  val lettuce = "io.lettuce" % "lettuce-core" % "6.3.2.RELEASE"

  // network
  val netty_common = "io.netty" % "netty-common" % "4.1.107.Final"
  val netty_handler = "io.netty" % "netty-handler" % "4.1.107.Final"
  ...
  val greenmail = "com.icegreen" % "greenmail" % "2.1.0-alpha-4" % "test"
  ...
  val mysql_connector_java = "com.mysql" % "mysql-connector-j" % "8.3.0"
  val mssql_jdbc = "com.microsoft.sqlserver" % "mssql-jdbc" % "12.6.1.jre11"

  val tomcat_embed_core = "org.apache.tomcat.embed" % "tomcat-embed-core" % "10.1.20"
  val io_undertow_core = "io.undertow" % "undertow-core" % "2.3.13.Final"
  val io_undertow_servlet = "io.undertow" % "undertow-servlet" % "2.3.13.Final"
