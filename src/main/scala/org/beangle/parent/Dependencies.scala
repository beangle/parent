...
object Dependencies extends sbt.AutoPlugin {
  ...
  val pdfbox = "org.apache.pdfbox" % "pdfbox" % "3.0.2"
  ...
  // network
  val netty_common = "io.netty" % "netty-common" % "4.1.111.Final"
  val netty_handler = "io.netty" % "netty-handler" % "4.1.111.Final"
  val netty_transport = "io.netty" % "netty-transport" % "4.1.111.Final"
  ...
  val io_undertow_servlet = "io.undertow" % "undertow-servlet" % "2.3.15.Final"
