...
object Dependencies extends sbt.AutoPlugin {
  ...
  val slf4j = "org.slf4j" % "slf4j-api" % "2.0.0-alpha5"
  val jcl_over_slf4j =  "org.slf4j" % "jcl-over-slf4j" % "2.0.0-alpha5"
  ...
  //cdi
  val spring_beans = "org.springframework" % "spring-beans" % "5.3.12"
  val spring_context = "org.springframework" % "spring-context" % "5.3.12"
  val spring_tx = "org.springframework" % "spring-tx" % "5.3.12"
  val spring_aop = "org.springframework" % "spring-aop" % "5.3.12"
  val spring_jdbc = "org.springframework" % "spring-jdbc" % "5.3.12"
  val protobuf = "com.google.protobuf" % "protobuf-java" % "3.19.1"

  val hibernate_core = "org.beangle.hibernate" % "beangle-hibernate-core" % "5.6.1.Final"
  ...
  val jgroups = "org.jgroups" % "jgroups" % "5.1.9.Final"
  val jedis = "redis.clients" % "jedis" % "3.7.0"
  ...
  val logback_core = "ch.qos.logback" % "logback-core" % "1.3.0-alpha10"
  ...
  val ojdbc11 = "com.oracle.database.jdbc" % "ojdbc11" % "21.3.0.0"
  val orai18n = "com.oracle.database.nls" % "orai18n" % "21.3.0.0"
  val mysql_connector_java = "mysql" % "mysql-connector-java" % "8.0.27"
  val mssql_jdbc = "com.microsoft.sqlserver" % "mssql-jdbc" % "9.4.0.jre11"

  val tomcat_embed_core = "org.apache.tomcat.embed" % "tomcat-embed-core" % "10.0.12"
  val io_undertow = "io.undertow" % "undertow-core" % "2.2.12.Final"
